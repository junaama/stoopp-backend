...
export default function Page() {
    return (
        <div className="min-h-screen flex flex-col">
            <header className=" bg-indigo-800 p-8 flex items-center justify-between text-white ">
                <div className="w-20 h-2"></div>
                <LogoIcon className="w-48 h-auto " color="white" />
                <div className="w-30">
                    <div><a href="">Sign In / Register</a></div>
                </div>
            </header>

            <div className="w-full bg-lime-100 p-4 gap-4 flex justify-around">
                <div>
            ...
            <div className="flex-1">
                <h2>RENT New Arrivals</h2>
                <div>Explore our newest pieces available to rent.</div>
                <div className="flex w-full justify-around">
                    <div>
                        Filters
                    </div>
                    <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                        <div className="flex flex-col w-30 h-auto rounded-md bg-gray-300 shadow-lg break-inside-avoid">
                            <div className="h-48">IMAGE HERE</div>
                            <div className="bg-white flex flex-col  p-4">
                                <div className="font-semibold">YVES SAINT LAURENT</div>
                                <div>White Coat, US 40</div>
                                <div className="flex gap-2">
                                    <div>Marker</div>
                                    <div className="font-semibold">Brooklyn, NY</div>
                                </div>
                                <div className="gap-2 flex">
                                    <span className="font-semibold">$42</span>
                                    <span className="line-through text-gray-500 font-semibold">$200</span>
                                </div>
                            </div>
                        </div>
                        <div className="flex flex-col w-30 h-auto rounded-md bg-gray-300 shadow-lg break-inside-avoid">
                ...
                <div className="bg-indigo-800">Title</div>
                <div className="bg-violet-800">Description</div>
                <div className="bg-purple-400">Color</div>

            </div>
            <footer className="flex p-8 gap-6 justify-between bg-indigo-800 text-white flex-wrap">
                <div >
                    <LogoIcon className="w-24 h-auto" color="white" />

                    <div className="px-2">creating expressive experiences through shared style</div>
                </div>
                <div>
                    <div className="font-semibold py-2">Resources</div>
                    <div><a>How It Works</a></div>
                    <div><a>Join As Lender</a></div>
                    <div><a>FAQ</a></div>
                    <div><a>Terms of Service</a></div>
                    <div><a>Privacy Policy</a></div>
                </div>
                <div>
                    <div className="font-semibold py-2">Contact</div>
                    <div><a>Instagram</a></div>
                    <div><a>Twitter</a></div>
                    <div><a>hi@stoopp.com</a></div>
                </div>
                <div>
                    <div className="font-semibold py-2">The App</div>
                    <div>Coming Soon!</div>
                </div>
            </footer>
        </div>
